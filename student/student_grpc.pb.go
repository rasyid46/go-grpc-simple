...
type DataStudentClient interface {
	FindStundentByemail(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Student, error)
}
...
func (c *dataStudentClient) FindStundentByemail(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Student, error) {
	out := new(Student)
	err := c.cc.Invoke(ctx, "/student.DataStudent/FindStundentByemail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataStudentServer interface {
	FindStundentByemail(context.Context, *Student) (*Student, error)
...
func (UnimplementedDataStudentServer) FindStundentByemail(context.Context, *Student) (*Student, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindStundentByemail not implemented")
}
...
func _DataStudent_FindStundentByemail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Student)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataStudentServer).FindStundentByemail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/student.DataStudent/FindStundentByemail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataStudentServer).FindStundentByemail(ctx, req.(*Student))
	}
...
var DataStudent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindStundentByemail",
			Handler:    _DataStudent_FindStundentByemail_Handler,
		},
	},
